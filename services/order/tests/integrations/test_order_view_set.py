...
class OrderIntegrationTest(TestCase):
	...
	def test_create_order_with_items(self):
		product1 = Product.objects.create(name='Product 1', description='Description 1', price=10.0)
		product2 = Product.objects.create(name='Product 2', description='Description 2', price=20.0)
