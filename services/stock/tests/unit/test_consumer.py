...
class TestConsumer(TestCase):
        ...
        with mock.patch("src.core.consumer.ReservationSerializer") as mock_serializer:
            with mock.patch("src.core.consumer.logger") as mock_logger:
                ...
                mock_serializer.assert_called_once_with(
                    data={"transaction_id": self.transaction_id, **self.data}
                )
    ...
    def test_receiver_order_sender(self, mock_published_create):
        ...
        with mock.patch(
            "src.core.consumer.create_reservation", mock_create_reservation
        ):
    ...
    def test_receiver_payment_sender(self, mock_published_create):
        ...
        with mock.patch(
            "src.core.consumer.confirm_reservation", mock_confirm_reservation
        ):
    ...
    def test_receiver_compensate(self, mock_published_create):
        ...
        with mock.patch(
            "src.core.consumer.cancel_reservation", mock_cancel_reservation
        ):
